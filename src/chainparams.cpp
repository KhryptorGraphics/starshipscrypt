...
{
    const char* pszTimestamp = "Trump administration withdrawing from UN Human Rights Council";
    const CScript genesisOutputScript = CScript() << ParseHex("042246C2463BB5316415191835367267CD1BFD61B6FB668C11579C34E30D7F98166774A5CD01968F62726486242A9596644B549E7E1EB6EB80835878E736DB1E2B") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("ea1b16226617f5aa371136b30a370ca6dffd6bcde9025c76287522e4bd40076e");
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1529470042; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1561006042; // December 31, 2008

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1529470042; // January 28, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1561006042; // January 31st, 2018

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1529470042; // January 28, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1561006042; // January 31st, 2018
        ...
        assert(consensus.hashGenesisBlock == uint256S("ea1b16226617f5aa371136b30a370ca6dffd6bcde9025c76287522e4bd40076e"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xa1, 0x86, 0xB2, 0x4B};
        base58Prefixes[EXT_SECRET_KEY] = {0xa1, 0x86, 0xAD, 0xE2};
        ...
        chainTxData = ChainTxData{
            ...
            1529470042, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1529470042; // January 1, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1561006042; // January 31st, 2018

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1529470042; // January 1, 2017
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1561006042; // January 31st, 2018
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0xa00"); //343833
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xa1, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0xa1, 0x35, 0x83, 0x94};
