...
#if defined(NDEBUG)
# error "Starshipscrypt cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Starshipscrypt Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s STSC additional fees, %d delta bytes\n",
