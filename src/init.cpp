...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/starshipscrypt-project/starshipscrypt>";
    const std::string URL_WEBSITE = "<https://starshipscrypt.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Starshipscrypt version %s\n", FormatFullVersion());
}
