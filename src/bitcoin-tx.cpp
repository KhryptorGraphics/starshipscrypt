...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s starshipscrypt-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  starshipscrypt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded starshipscrypt transaction") + "\n" +
              "  starshipscrypt-tx [options] -create [commands]   " + _("Create hex-encoded starshipscrypt transaction") + "\n" +
              "\n";
